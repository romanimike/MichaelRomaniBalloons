...
Every page currently uses a placeholder domain: `https://michaelromaniballoons.com/`. Once you've picked and purchased your real domain:

1. Find-and-replace `https://michaelromaniballoons.com` with your real domain across all HTML files, `robots.txt`, and `sitemap.xml`.
...
- **12 pages**: Home, full Balloon Twisting services page, 6 neighborhood landing pages, a Nearby Suburbs page, Gallery with lightbox, Meet Michael, and Contact.
